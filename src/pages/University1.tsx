...
import { university1Data } from "@/data/universityData";
    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <h1 className="text-xl font-bold">{university1Data.name}</h1>
          <Button 
            variant="outline" 
            size="sm"
      ...
      <div className="pt-16">
        <Hero
          title={university1Data.name}
          tagline={university1Data.tagline}
          description={university1Data.heroDescription}
          heroImage="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=2000"
      ...
      {/* Stats */}
      <Stats stats={university1Data.stats} />
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed text-center">
            {university1Data.overview}
          </p>
        </div>
      </section>

      {/* Features */}
      <Features features={university1Data.features} />

      {/* Courses */}
      <Courses courses={university1Data.courses} onApplyNow={scrollToForm} />

      {/* Placements */}
      <Placements placements={university1Data.placements} />

      {/* Application Form */}
      <section id="apply-form" className="py-20 bg-background">
        <div className="container mx-auto px-4 max-w-2xl">
          <LeadForm 
            courses={university1Data.courses.map(c => c.name)}
            universityName={university1Data.name}
          />
        </div>
      </section>
      ...
      <FeeModal
        ...
        courses={university1Data.courses}
        universityName={university1Data.name}
      />
      ...
      <footer className="bg-primary text-primary-foreground py-8">
        <div className="container mx-auto px-4 text-center">
          <p className="text-sm">© 2025 {university1Data.name}. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
